...
the family likes to find the oldest 
living family member’s age and the 
youngest family member’s age and calculate 
...
function differenceInAges(ages){
    ...
    return [a[a.length-1], a[0], a[0] - a[a.length-1]]
  }